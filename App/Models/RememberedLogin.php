...
class RememberedLogin extends \Core\Model
{
	...
	/**
	* Find the remembered login model by the token
	*
	* @param string $token The remembered login token
	*
	* @retun mixed Remembered login obcjet if found, false otherwise
	**/
	...
	*
	* @retun boolean True if the token has expired, false otherwise
	**/
